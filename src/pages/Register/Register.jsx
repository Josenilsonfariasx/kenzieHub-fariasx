                ...
                <div>
                    <form onSubmit={handleSubmit(submit)}>
                        <div>
                            ...
                            <label
                                htmlFor="module"
                                className="title headline white"
                            >
                                Selecionar modulo
                            </label>
                            <select
                            ...
                            >
                                ...
                                <option value="Primeiro modulo (M1)">
                                    Primeiro modulo
                                </option>
                                <option value="Segundo modulo (M2)">
                                    Segundo modulo
                                </option>
                                <option value="Terceiro modulo (M3)">
                                    Terceiro modulo
                                </option>
                                <option value="Quarto modulo (M4)">
                                    Quarto modulo
                                </option>
                                <option value="Quinto modulo (M5)">
                                    Quinto modulo
                                </option>
                                <option value="Sexto modulo (M6)">
                                    Sexto modulo
                                </option>
                            </select>
                            {errors.course_module ? (
                                <span className="title headline rose">
